            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none min-h-[100px] resize-y"
                  placeholder="타이틀을 입력하세요 (여러 줄 가능)"
                />
              </div>
              <div>
